...
const StyledColumnContainerGap = styled.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
`;
    ...
    <StyledSignUpPage>
      ...
      <StyledSignUpContainer>
        ...
        <StyledSignUpInputContainer>
          ...
          <StyledColumnContainer>
            <StyledLabel htmlFor='area'>지역</StyledLabel>
            <CustomDropdown options={administrativeDistrict} width='300px' onSelected={(value) => handleAreaChange(value, 'area')} />
          </StyledColumnContainer>
          <StyledColumnContainer>
            <StyledLabel htmlFor='job'>직업</StyledLabel>
            <SimpleInput placeholder='직업을 입력하세요' id='job' value={registrationData.job} onInputChange={handleJobChange} />
          </StyledColumnContainer>
          <StyledColumnContainer>
            <StyledLabel htmlFor='hashtag'>MBTI/흥미/특기</StyledLabel>
            <SimpleInput placeholder='나를 표현하는 단어를 입력하고 엔터를 눌러주세요' id='hashtag' value={tagItem} onInputChange={handleTagChange} onEnterKeyUp={(value) => handleChipCreation(value)} />
